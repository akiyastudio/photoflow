// Compatibility adapter for development-era media process requests.
...
const translateLegacyMediaProcess = (payload, descriptor) => {
...
module.exports={isLegacyAction,translateLegacyMediaProcess};
