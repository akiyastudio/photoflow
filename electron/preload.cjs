...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  openTeamRetouchIdentityModelsFolder: () => ipcRenderer.invoke('team-retouch-identity-models-open-folder'),
  installTeamRetouchIdentityModels: () => ipcRenderer.invoke('team-retouch-identity-models-install'),
