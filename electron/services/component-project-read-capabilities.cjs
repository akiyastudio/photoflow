...
const registerComponentProjectReadCapabilities = ({
  ...
  broker.register('project.files.page.v1', (payload, context, descriptor) => filePage(payload, context, descriptor, false));
  broker.register('project.files.search.v1', (payload, context, descriptor) => filePage(payload, context, descriptor, true));

  broker.register('project.media.metadata.v1', async (payload, context, descriptor) => {
  ...
  broker.register('project.versions.page.v1', async (payload, context, descriptor) => {
  ...
  broker.register('project.version.graph.v1', async (payload, context, descriptor) => {
  ...
  broker.register('project.media.ratings.v1', async (payload, context, descriptor) => {
