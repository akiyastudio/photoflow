...
const registerWorkspaceIpc = context => {
  ...
  registerInspirationIpc({
    Array, Error, Set, String, assertExistingInside, copyFileAtomic, fs, getProjectPath, ipcMain, mainWindow, path, pushUndoOperation,
    resolveProjectEntry, shell, uniqueDestination, writeLog,
  });
