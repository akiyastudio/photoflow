...
const run = async () => {
  ...
  const host = { componentId: 'smoke-host', componentVersion: '1.0.0', contractVersion: 2, componentRoot: fixtureRoot,
    fullPage: { id: 'main', title: 'Host', entry: hostPage }, toolbarAction: { id: 'open', label: 'Host' }, service: { events: ['sample.changed.v2'], permissions: [] } };
  const legacy = { componentId: 'smoke-legacy', componentVersion: '1.0.0', contractVersion: 1, componentRoot: fixtureRoot,
