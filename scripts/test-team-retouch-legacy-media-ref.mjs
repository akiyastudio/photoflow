...
const { legacyPreviewRequests, readableLegacyMediaError, summarizeLegacyPreviewResults } = await import(pathToFileURL(path.resolve('extensions/team-retouch/renderer/src/legacy/legacy-media-preview-model.ts')).href);
const cases = [
