...
const cleanupOwnedComponentPath = receipt => cleanupOwnedComponentPathRaw(receipt, { captureNativeProof: testCaptureNativeProof, deleteOwned: testDeleteOwned, prepareSidecars: testPrepareSidecars, persistPrepared: async () => true });
