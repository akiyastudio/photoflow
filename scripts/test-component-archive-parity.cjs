...
const testDeleteSidecar = async ({ path: sidecarPath, expectedContent }) => { assert.equal(fs.readFileSync(sidecarPath, 'utf8'), expectedContent); await fs.promises.unlink(sidecarPath); };
