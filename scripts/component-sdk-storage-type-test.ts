...
const pending: ComponentStorageResponse = {
  apiVersion: 7, projectId: 'project', ownership: 'component-private',
...
const committed: ComponentStorageResponse = {
  apiVersion: 7, dataPath: 'private', databasePath: 'private/storage.sqlite3', projectId: 'project', ownership: 'component-private',
...
const incompleteCommitted: ComponentStorageResponse = { apiVersion: 7, dataPath: 'private', databasePath: 'db', projectId: 'project', ownership: 'component-private', adoption: { schemaVersion: 1, kind: 'component-storage-adoption', state: 'committed', componentId: 'sample-component', fromHostApiVersion: 1, toHostApiVersion: 2 } };
