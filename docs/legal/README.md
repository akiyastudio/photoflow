...
适用版本：照片流 26.8.30 公测版

本目录中的对外文件会随桌面安装包分发，并可在“设置 → 隐私与数据”中打开。
...
1. 运营者真实姓名或登记主体全称、注册地址/常用办公地址。
2. 个人信息权利请求处理人和稳定联系渠道。
3. 腾讯云实际账号主体、地域、数据库保存及删除任务。
5. 人脸信息个人信息保护影响评估的签署人和批准记录。
6. 第三方软件完整许可证、FFmpeg 对应源码及构建参数。
