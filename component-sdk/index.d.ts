...
export type ComponentRuntimeExecuteResponse = { sourcePreviews: JsonObject[] } | { operationId: string; result: JsonObject } | { operationId: string; task: JsonObject | null } | { operationId: string; cancelled: boolean; task: JsonObject | null };
