...
export const THIRD_PARTY_SOFTWARE_LICENSES: ThirdPartySoftwareLicense[] = [
  ...
  { group: '本地组件', name: 'FFmpeg Media Encoder 运行库', version: 'FFmpeg 7.1.1 · 所有依赖固定提交', purpose: '视频分析、预览、切分、H.264/HEVC 8/10-bit、AV1 硬件、ProRes、HDR 色调映射与字幕烧录', license: 'GPL-2.0-or-later', sourceUrl: 'https://ffmpeg.org/', licenseUrl: 'https://www.gnu.org/licenses/old-licenses/gpl-2.0.html', note: '精简静态构建包含 x264、x265 8/10-bit、zlib、zimg、libass、FreeType、FriBidi、HarfBuzz、nv-codec-headers、NVENC 与 Windows Media Foundation/D3D11。zimg、字幕栈和 NVENC 头文件保留各自宽松许可；禁用 xvid、Avisynth、rubberband、nonfree 和网络功能。精确对应源码、构建材料和许可证随发行归档留存。' },
  { group: '本地组件', name: 'mpv / libmpv', version: '0.41.0（视频播放器运行时）', purpose: '相机视频播放、字幕、硬件解码、缓存与音视频同步', license: 'LGPL-2.1-or-later', sourceUrl: 'https://github.com/mpv-player/mpv', licenseUrl: 'https://github.com/mpv-player/mpv/blob/master/Copyright', note: '组件仅接受 -Dgpl=false 的 libmpv，并强制校验所链接 FFmpeg 为 LGPL 构建且不含 GPL/nonfree 组件；对应源码、许可证、配置和文件哈希随组件归档提供。' },
