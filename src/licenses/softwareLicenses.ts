...
export const THIRD_PARTY_SOFTWARE_LICENSES: ThirdPartySoftwareLicense[] = [
  ...
  { group: '主程序', name: 'Electron', version: '43.2.0', purpose: '桌面应用运行框架', license: 'MIT', sourceUrl: 'https://github.com/electron/electron', licenseUrl: 'https://github.com/electron/electron/blob/main/LICENSE' },
  { group: '主程序', name: 'Chromium', version: '随 Electron 43.2.0', purpose: '网页渲染与多媒体运行环境', license: 'BSD-3-Clause + 第三方许可', sourceUrl: 'https://chromium.googlesource.com/chromium/src/', licenseUrl: 'https://chromium.googlesource.com/chromium/src/+/main/LICENSE', note: '发布包还必须保留 Electron 随附的 LICENSES.chromium.html。' },
  { group: '主程序', name: 'Node.js', version: '随 Electron 43.2.0', purpose: '主进程与本地文件功能', license: 'MIT + 第三方许可', sourceUrl: 'https://github.com/nodejs/node', licenseUrl: 'https://github.com/nodejs/node/blob/main/LICENSE' },
  ...
  { group: '本地组件', name: 'rawpy', version: '0.27.0', purpose: '高级 RAW 解码组件的 LibRaw Python 封装', license: 'MIT', sourceUrl: 'https://github.com/letmaik/rawpy', licenseUrl: 'https://github.com/letmaik/rawpy/blob/main/LICENSE' },
  { group: '本地组件', name: 'LibRaw', version: '随 rawpy 0.27.0 稳定版二进制包', purpose: '相机 RAW 传感器数据解析、去马赛克和色彩转换', license: 'LGPL-2.1-or-later OR CDDL-1.0', sourceUrl: 'https://www.libraw.org/', licenseUrl: 'https://www.libraw.org/about' },
  ...
  { group: '本地组件', name: 'FFmpeg + x264 + x265 + zlib', version: 'FFmpeg 7.1.1 · x264/x265/zlib 固定提交', purpose: '视频预览、PNG 抽帧、切分与 H.264/H.265 转码', license: 'GPL-2.0-or-later', sourceUrl: 'https://ffmpeg.org/', licenseUrl: 'https://www.gnu.org/licenses/old-licenses/gpl-2.0.html', note: '照片流使用固定源码提交的精简自建版本，启用 libx264、libx265、zlib 与 Windows Media Foundation/D3D11 硬件视频接口，其中 zlib 保留其宽松许可；禁用 xvid、Avisynth、rubberband、nonfree 和网络功能。精确对应源码、构建材料和许可证按发行版本单独留存，不写入更新数据库。' },
