...
export const THIRD_PARTY_SOFTWARE_LICENSES: ThirdPartySoftwareLicense[] = [
  ...
  { group: '本地组件', name: 'FFmpeg Media Encoder 运行库', version: 'FFmpeg 7.1.5 · 所有依赖固定提交', purpose: '视频分析、预览、切分、H.264/HEVC 8/10-bit、AV1 硬件、ProRes、HDR 色调映射与字幕烧录', license: 'GPL-2.0-or-later', sourceUrl: 'https://ffmpeg.org/', licenseUrl: 'https://www.gnu.org/licenses/old-licenses/gpl-2.0.html', note: '精简静态构建包含 x264、x265 8/10-bit、zlib、zimg、libass、FreeType、FriBidi、HarfBuzz、nv-codec-headers、NVENC、Vulkan/libplacebo 与 Windows Media Foundation/D3D11。zimg、字幕栈、GPU 着色器工具链和 NVENC 头文件保留各自许可证；禁用 xvid、Avisynth、rubberband、nonfree 和网络功能。精确对应源码、构建材料和许可证随发行归档留存。' },
  { group: '本地组件', name: 'libplacebo', version: '7.351.0', purpose: 'Vulkan GPU HDR→SDR 色调映射', license: 'LGPL-2.1-or-later', sourceUrl: 'https://github.com/haasn/libplacebo', licenseUrl: 'https://github.com/haasn/libplacebo/blob/master/LICENSE' },
  { group: '本地组件', name: 'shaderc 与 Vulkan 着色器工具链', version: 'shaderc 2026.3 · glslang 16.3.0 · SPIR-V Tools / Vulkan-Headers 1.4.357.0', purpose: '运行时编译 libplacebo Vulkan 着色器', license: 'Apache-2.0', sourceUrl: 'https://github.com/google/shaderc', licenseUrl: 'https://github.com/google/shaderc/blob/main/LICENSE', note: '发行归档同时保留 glslang、SPIR-V Tools 与 Vulkan-Headers 的许可证和精确 MSYS2 包版本。' },
