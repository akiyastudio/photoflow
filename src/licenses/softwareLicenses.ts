...
export const THIRD_PARTY_SOFTWARE_LICENSES: ThirdPartySoftwareLicense[] = [
  ...
  { group: '本地组件', name: 'FFmpeg + x264 + x265 + zlib', version: 'FFmpeg 7.1.1 · x264/x265/zlib/nv-codec-headers 固定提交', purpose: '视频预览、PNG 抽帧、切分与 H.264/H.265 转码', license: 'GPL-2.0-or-later', sourceUrl: 'https://ffmpeg.org/', licenseUrl: 'https://www.gnu.org/licenses/old-licenses/gpl-2.0.html', note: '照片流使用固定源码提交的精简自建版本，启用 libx264、libx265、zlib、NVIDIA NVENC 与 Windows Media Foundation/D3D11 硬件视频接口；zlib 与 nv-codec-headers 保留各自宽松许可。禁用 xvid、Avisynth、rubberband、nonfree 和网络功能。精确对应源码、构建材料和许可证按发行版本单独留存，不写入更新数据库。' },
