...
build flags, checksums and corresponding-source archives are identified by the
runtime manifest and `media-runtime.lock.json` in the PhotoFlow source tree.
