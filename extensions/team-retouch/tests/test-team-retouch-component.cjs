...
for (const capability of ['project.media.page','project.output','version.create','tasks','component.storage','component.settings','component.lifecycle']) assert(service.includes(`'${capability}'`));
