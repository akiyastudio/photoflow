...
const TeamSettingsDialog = ({ state, patch, retry, close, notice }: { state: TeamSettingsState; patch: ReturnType<typeof createTeamSettingsController>['patch']; retry: () => void; close: () => void; notice: (message: string) => void }) => {
